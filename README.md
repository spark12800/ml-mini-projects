...
A collection of small, self-contained ML experiments spanning vision, NLP, audio, and theoretical machine learning.  
Each folder contains a Jupyter notebook and a brief README describing the objective, method, and key observations.
